                        ...
                        <table className="min-w-full divide-y divide-gray-200">
                            <thead className="bg-gray-50">
                                <tr>
                                    ...
                                    >
                                        SĐT {sortField === 'phone' && (sortDirection === 'asc' ? '▲' : '▼')}
                                    </th>
                            ...
                            <tbody className="bg-white divide-y divide-gray-200">
                                {paginatedStudents.map((student) => (
                                    <tr key={student.student_id} className="hover:bg-gray-50">
                                        ...
                                        <td className="px-4 py-3 whitespace-nowrap">{student.User?.email || ''}</td>
                                        <td className="px-4 py-3 whitespace-nowrap">{student.phone || ''}</td>
                                        <td className="px-4 py-3 whitespace-nowrap">
                                            <span className={`px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-full ${student.status === 'disciplined' ? 'bg-red-100 text-red-800' : 'bg-green-100 text-green-800'
                                                }`}>
