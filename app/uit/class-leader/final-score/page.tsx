...
export default function ClassLeaderFinalScorePage() {
      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-6">
          <h1 className="text-3xl font-bold text-gray-800 mb-2">
            Bảng điểm tổng kết - Lớp trưởng
          </h1>
          <p className="text-gray-600">
            Xem điểm tổng kết rèn luyện cá nhân của bạn
          </p>
        </div>
        ...
        <div className="mb-6">
          <div className="bg-white p-6 rounded-lg shadow-md">
            <h3 className="text-lg font-semibold mb-4">Bảng điểm tổng kết theo học kỳ</h3>
