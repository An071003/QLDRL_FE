...
export default function AdvisorFacultiesPage() {
  ...
  // Pagination logic
  const totalPages = Math.ceil(sortedAndFilteredFaculties.length / itemsPerPage);
  const paginatedFaculties = sortedAndFilteredFaculties.slice(
              ...
              <div>
                <p className="text-sm text-gray-700">
                  ...
                  <span className="font-medium">
                    {Math.min(currentPage * itemsPerPage, sortedAndFilteredFaculties.length)}
                  </span>{' '}
                  trong tổng số <span className="font-medium">{sortedAndFilteredFaculties.length}</span> khoa
                </p>
              </div>
              <div>
