...
import StudentDropdown from "@/components/classleader/ClassLeaderDropdown";
import ClassLeaderDropdown from '@/components/classleader/ClassLeaderDropdown';

export const metadata = {
  title: 'Trang dành cho lớp trưởng',
};
